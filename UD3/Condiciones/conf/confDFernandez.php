...
$principales = [
    ...
    "Ej1" => "/DWES/UD3/Condiciones/Ejercicio1/DFernandezEjercicio1Meses.php",
    "Ej2" => "/DWES/UD3/Condiciones/Ejercicio2/DFernandezEjercicio2.php",
    "Ej3" => "/DWES/UD3/Condiciones/Ejercicio3/DFernandezEjercicio3.php",
    "Ej4" => "/DWES/UD3/Condiciones/Ejercicio4/DFernandezEjercicio4.php",
    "Ej5" => "/DWES/UD3/Condiciones/Ejercicio5/DFernandezEjercicio5.php",
...
<a href="/DWES/UD3/conf/confDFernandez.php">
    ...
    <p class="pActividades">Condiciones</p>
