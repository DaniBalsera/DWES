...
$router->add(array(
    "name" => "create-project",
    'path' => '/^\/proyecto\/crear$/',
    'action' => [PortfolioController::class, 'showCreateProjectForm']
));

$router->add(array(
    "name" => "create-project-post",
    'path' => '/^\/create-project$/',
    'action' => [PortfolioController::class, 'createProject']
));
...
$router->add(array(
    "name" => "create-social",
    'path' => '/^\/social\/crear$/',
    'action' => [PortfolioController::class, 'showCreateSocialForm']
));

$router->add(array(
    "name" => "create-social-post",
    'path' => '/^\/create-social$/',
    'action' => [PortfolioController::class, 'createSocial']
));
