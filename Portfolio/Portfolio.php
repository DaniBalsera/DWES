...
$arbol = "/DWES/conf/confDFernandez.php";
...
<a href="#" onclick="abrirVentana('<?php echo $urlArbol; ?>');">
    <img class="iconoCarpeta" src="CarpetaAnimada.png" style="width: 150px; height: auto; cursor: pointer;">
</a>
